...
- (void)config {
    self.imagesArray = [NSArray arrayWithObjects: [UIImage imageNamed:@"share_wechat_normal"], [UIImage imageNamed:@"share_wechat_normal"], [UIImage imageNamed:@"share_qzone_normal"], [UIImage imageNamed:@"share_qq_normal"], nil];

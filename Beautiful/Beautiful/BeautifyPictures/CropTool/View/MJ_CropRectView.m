...
#import "MJ_CropRectView.h"
#import "PEResizeControl.h"

@interface MJ_CropRectView ()
<PEResizeControlViewDelegate>

@property (nonatomic, strong) PEResizeControl *topLeftCornerView;
@property (nonatomic, strong) PEResizeControl *topRightCornerView;
@property (nonatomic, strong) PEResizeControl *bottomLeftCornerView;
@property (nonatomic, strong) PEResizeControl *bottomRightCornerView;
@property (nonatomic, strong) PEResizeControl *topEdgeView;
@property (nonatomic, strong) PEResizeControl *leftEdgeView;
@property (nonatomic, strong) PEResizeControl *bottomEdgeView;
@property (nonatomic, strong) PEResizeControl *rightEdgeView;

@property (nonatomic, assign) CGRect initialRect;
@property (nonatomic, assign) CGFloat fixedAspectRatio;

@end

@implementation MJ_CropRectView
...
- (id)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        imageView.image = [[UIImage imageNamed:@"MJ_PhotoCropEditorBorder"] resizableImageWithCapInsets:UIEdgeInsetsMake(23.0f, 23.0f, 23.0f, 23.0f)];
...
- (CGRect)cropRectMakeWithResizeControlView:(PEResizeControl *)resizeControlView {
    ...
    if (resizeControlView == self.topEdgeView) {
        ...
        if (self.keepingAspectRatio) {
            ...
            if (fabs(resizeControlView.translation.x) < fabs
                (resizeControlView.translation.y)) {

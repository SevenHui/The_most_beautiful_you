...
- (void)creatTopView {
    ...
    //    设置
    MJ_Button *buttonOfSet = [MJ_Button buttonWithFrame:CGRectMake(WIDTHVIEW * 0.48, HEIGHTVIEW * 0.027, HEIGHTVIEW * 0.05, HEIGHTVIEW * 0.05) type:UIButtonTypeCustom title:nil image:[UIImage imageNamed:@"设置"] color:[UIColor greenColor] addBlock:^(MJ_Button *button) {

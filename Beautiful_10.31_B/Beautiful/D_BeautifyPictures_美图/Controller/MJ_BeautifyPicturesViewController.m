...
- (void)createImageView {
    self.imageView = [[UIImageView alloc] initWithFrame:CGRectMake(0, 64, WIDTHSCREEN, HEIGHTSCREEN * 0.81)];
...
- (void)createBottomView {
    UIView *buttomView = [[UIView alloc] initWithFrame:CGRectMake(0, _imageView.frame.size.height + 64, WIDTHSCREEN, HEIGHTSCREEN - (_imageView.frame.size.height + 64))];
